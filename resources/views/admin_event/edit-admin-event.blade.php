                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <input type="text" class="form-control" value="{{ $value['username'] }}" required="" name="username" id="username">
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <input type="password" class="form-control" value="{{ $value['password_encrypts'] }}" required="" name="password" id="password">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    <select class="form-control select2" name="event" id="event">
                                        ...
                                        <option value="{{ $value['event_id'] }}" {{ $event->id_event == $value['event_id'] ? 'selected' : '' }}>{{ $event->title }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        Status Wajib Diisi
