                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (message == "user") {
                            ...
                            swal('Gagal', 'Full Name tidak boleh kosong, silahkan coba lagi',
                                'error')
                        } else if (message == "password") {
                            swal('Gagal', 'Password minimal 8 karakter, silahkan coba lagi',
                                'error')
                        } else if (message == "password doesnt same") {
                            swal('Gagal',
                                'Password Konfirmasi harus sama dengan Password, silahkan coba lagi',
                                'error')
                        } else if (message == "username") {
                            swal('Gagal', 'Username tidak boleh kosong, silahkan coba lagi',
                                'error')
