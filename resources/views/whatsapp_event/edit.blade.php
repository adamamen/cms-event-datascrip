...
@section('title', 'Edit WhatsApp Event')
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Form WhatsApp Event</h2>
                <div class="row">
        ...
        $(document).ready(function() {
            ...
            $("#btn_cancel").click(function() {
                swal({
                    ...
                    .then((ok) => {
                        if (ok) {
                            window.location.href = "{{ url('/') }}" + "/whatsapp-event/" + params;
                        }
                    });
            });
            ...
            $("#btn_submit").click(function() {
                ...
                if (event == null) {
                    ...
                    $.ajax({
                        url: '{{ route('update-whatsapp-event') }}',
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
